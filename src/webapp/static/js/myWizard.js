...
Wizard.prototype = {
    ...
    setState: function () {
        ...
        if (data && data.last) {
            ...
            if (typeof this.lastText !== 'undefined') {
                ...
                if (lastStep === true) {
                    text = this.lastText;
                    this.$nextBtn.find("i.icon-arrow-right").hide();

                } else {
                    this.$nextBtn.find("i.icon-arrow-right").show();
                }
    ...
    stepclicked: function (e) {
        ...
        var ev = $.Event('change');
        this.$element.trigger(ev, {step: this.currentStep, direction: 'set', target: index});
    ...
    next: function () {
        ...
        var lastStep = (this.currentStep + 1 === this.numSteps);
